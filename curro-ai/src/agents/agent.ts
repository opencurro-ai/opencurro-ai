...
export class AgentRunner {
  ...
  async run(
    ...
    try {
      ...
      // five multi-agent TEAM tools are ALWAYS hidden from the single agent — they are exposed only
      // to agents running inside a multi-agent collaboration team (see the multiagent runtime).
