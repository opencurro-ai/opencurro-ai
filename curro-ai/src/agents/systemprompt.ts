...
- All file paths you pass to tools are resolved relative to this workspace. Prefer simple relative paths like "src/index.ts". Never try to touch files outside the workspace.
...
- file_read(file_path): Read a file's full contents. Read a file before editing it when you are unsure of its exact contents.
